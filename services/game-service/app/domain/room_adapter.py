"""Port (protocol) for fetching room configuration.

The domain layer defines *what* data it needs; the infrastructure
layer decides *how* to obtain it (HTTP call vs. local snapshot).
"""
